 ...
 *
 */
public class DatePropertyValueFactory extends PropertyValueFactory<LatestFinishDateTodoItem,String> {
     ...
     */
    @Override
    public ObservableValue<String> call(TableColumn.CellDataFeatures<LatestFinishDateTodoItem, String> todoItem) {
